                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-dark-lighterBg dark:border-gray-700">
                            {navItems.map((item) => (
                                <li key={item.href}>
                                    <a
                                        href={item.href}
                                        className={`text-xl block py-2 px-3 rounded md:bg-transparent md:p-0 md:dark:hover:text-dark-secondary ${router.pathname === item.href ? 'text-white bg-blue-700 md:text-blue-700 md:dark:text-dark-secondary' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'}`}
                                    >
                                        {item.label}
                                    </a>
                                </li>
